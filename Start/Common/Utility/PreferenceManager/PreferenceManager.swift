...
extension PreferenceKeys {
    ...
    static let lastVersion = PreferenceKey<String>("LastVersion")
    static let currentVersion = PreferenceKey<String>("CurrentVersion")
    static let enterbackgroundTime = PreferenceKey<Double>("EnterbackgroundTime")
...
let defaultPreferences: [PreferenceKeys: Any] = [
    ...
    .lastVersion: "",
    .currentVersion : "",
    .enterbackgroundTime : 0.0,
    //.userInfo: NSKeyedArchiver.archivedData(withRootObject: UserInfo(id: 0, name: "",password:"" ,token : "" ,account : "")),
]
